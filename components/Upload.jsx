      ...
      <div className="w-full h-screen flex flex-col items-center justify-start overflow-y-scroll pt-14 scrollbar-hide relative">
        <div className="w-full flex flex-col items-center justify-start pr-36 pl-36 relative">
          ...
          <ul className="text-md font-light text-gray-800 list-disc p-8 pr-24 pl-24">
            <li>
              Your uploads will be distributed for free under the Pexels
              license. Learn more
            </li>
            <li>
            ...
            <li>
              We will review your submission. If it gets selected, you will
        ...
        <div className="w-full flex flex-col items-center justify-center mt-8 pl-20 pr-20">
          <form
            action=""
            method="post"
            className="w-full h-24 bg-gray-100 border-2 border-gray-400 border-dashed flex flex-col items-center justify-center cursor-pointer"
          >
            <input
              type="file"
              name="image"
              id="image"
              className="cursor-pointer file:cursor-pointer file:bg-pexels file:outline-none file:p-2 file:pl-4 file:pr-4 file:rounded-md file:text-white file:font-light file:border-none"
              onChange={handleInput}
            />
          </form>
          <button
            type="button"
            className="bg-pexels p-2 pl-4 pr-4 rounded-sm mt-4 font-light text-white"
            onClick={() => router.push("/")}
          >
            Upload later
          </button>
        ...
        <div className="w-full flex items-center justify-center p-16 mb-8 relative">
          {url ? (
              ...
              <div className="w-full h-full flex justify-center items-center p-4">
                <form className="w-full h-full flex flex-col justify-center items-center m-4 p-4">
                  <input
                    ...
                    name="Title"
                    placeholder="Title"
                    className="w-full p-4 m-2 rounded-md outline-none border border-gray-100 focus:bg-gray-300 "
                  ...
                  <button
                    type="button"
                    name="Save"
                    className="w-1/2 p-4 m-2 rounded-md outline-none border border-gray-100 bg-pexels text-white pointer-cursor font-light "
            ...
            progress > 0 && (
              <motion.div
                className="h-[30px] text-white font-semibold mt-8 rounded-xl text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center"
                initial={{ width: 0 }}
